...
public:
	const IloDataCollection::IloDataType getType() const { return _type;}
...
public:
	//void build(IloExtendedComprehensionI* comp, IloModelEvaluatorI* eval=0);
	virtual IloDataCollectionI* copy() const;
...
public:
	virtual IloDataCollectionI* copy() const;
	IloIntArrayAsCollectionI(const IloIntArray array);
...
public:
	virtual IloDataCollectionI* copy() const;
	IloNumArrayAsCollectionI(const IloNumArray array);
...
public:
	virtual IloDataCollectionI* copy() const;
	IloAnyArrayAsCollectionI(const IloAnyArray array);
