...
public:
	...
	IloExpr(const IloEnv env, IloNum = 0);
...
public:
	...
	class IloOverflowOccured : public IloException {
	public:
		IloOverflowOccured(const char * message) : IloException(message) {}
		virtual ~IloOverflowOccured(){}
	};
};
...
ILO_EXPORTEDFUNCTION(IloNumExprArg) IloScalProd(const IloIntVarArray vars,
												const IloNumArray values);
ILO_EXPORTEDFUNCTION(IloNumExprArg) IloScalProd(const IloIntArray values,
												const IloNumVarArray vars);
ILO_EXPORTEDFUNCTION(IloNumExprArg) IloScalProd(const IloNumVarArray vars,
												const IloIntArray values);
ILO_EXPORTEDFUNCTION(IloNumExprArg) IloScalProd(const IloNumExprArray leftExprs,
												const IloNumExprArray rightExprs);
ILO_EXPORTEDFUNCTION(IloIntExprArg) IloScalProd(const IloIntArray values,
												const IloIntVarArray vars);
ILO_EXPORTEDFUNCTION(IloIntExprArg) IloScalProd(const IloIntVarArray vars,
												const IloIntArray values);
ILO_EXPORTEDFUNCTION(IloIntExprArg) IloScalProd(const IloIntExprArray leftExprs,
												const IloIntExprArray rightExprs);
