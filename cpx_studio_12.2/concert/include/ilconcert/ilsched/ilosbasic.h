...
/** Returns >0 if and only if at least one of the bits 'bit1', 'bit2' and 'bit3' is 1. */
...
/** Returns >0 if and only if at least one of the bits 'bit1', 'bit2', 'bit3' and 'bit4' is 1. */
...
/** Returns >0 if and only if at least one of the bits 'bit1', 'bit2', 'bit3', 'bit4' and 'bit5' is 1. */
...
/** Returns >0 if and only if both bits 'bit1' and 'bit2' are 1. */
