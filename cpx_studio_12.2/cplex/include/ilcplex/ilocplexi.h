...
public:
  ...
  void writeVectors(const char* name) const;
  void writeTextSolution(const char* name) const;
  ...
  void readVectors(const char* name) const;
  ...
  /*
   * <p>This method puts the solution values of the numeric variables
   * specified by the array <code>var</code> into the array
   * <code>val</code>.  Array <code>val</code> is resized to the same size as
   * array <code>var</code>, and <code>val[i]</code> will contain the
   * solution value for variable <code>var[i]</code>.</p>
   */
  ...
  /*
   * <p>This method puts the values from the solution pool member
   * indexed by <code>soln</code> for the integer variables
   * specified by the array
   * <code>var</code> into the array <code>val</code>.
   * The <code>soln</code> argument may be omitted or given a value of -1
   * in order to access the current solution. 
   * Array <code>val</code> is resized to the same size as
   * array <code>var</code>, and <code>val[i]</code> will contain the
   * solution value for variable <code>var[i]</code>.</p>
   */
  ...
  void        setParam(IntParam    parameter, IloInt value);
  ...
  IloInt      getParam(IntParam    parameter) const;
  ...
  public:
    ...
    void setParam(IntParam which, IloInt val) {
       IloAssert(_impl, "Using empty handle IloCplex::ParameterSet");
    ...
    IloInt getParam(IntParam which) const {
       IloAssert(_impl, "Using empty handle IloCplex::ParameterSet");
...
#define CPX_MIPSEARCH_DYNAMIC            2
  ...
  public:
    /*
     * <p>This method returns the callback type of the invoking
     * callback object.</p>
     */
  ...
  public:
    ...
    void    getIncumbentValues (IloNumArray val,
       ...
       IloAssert (val.getImpl(), "array is not initialized");
       IloAssert (vars.getImpl(), "array is not initialized");
       doGetIncumbentValues(val, *(IloNumVarArray*)(void*)&vars);
    }
  ...
  public:
    ...
    void   getObjCoefs(IloNumArray val, const IloIntVarArray vars) const {
      IloAssert(val.getImpl(), "array not initialized");
      IloAssert(vars.getImpl(), "array not initialized");
      doGetObjCoefs(val, *(IloNumVarArray*)(void*)&vars);
    }
  ...
  public:
    ...
    void getValues (IloNumArray val, const IloIntVarArray vars) const {
      IloAssert(val.getImpl(), "array not initialized");
      IloAssert(vars.getImpl(), "array not initialized");
      doGetValues(val, *(IloNumVarArray*)(void*)&vars);
    }
  ...
  public:
    NodeId getNodeId(int node) const;

    IloNum getObjValue(int node) const;

    IloNum getEstimatedObjValue(int node) const;

    IloInt getDepth(int node) const;

    IloNum getInfeasibilitySum(int node) const;

    IloInt getNinfeasibilities(int node) const;

    NodeData  *getNodeData(int node) const;

    void selectNode(int node);

    IloNumVar getBranchVar(int node) const;
  ...
  public:
    ...
    void getFeasibilities(IntegerFeasibilityArray stat,
      ...
      IloAssert (stat.getImpl(), "array is not initialized");
      IloAssert (var.getImpl(), "array is not initialized");
      doGetFeasibilities(stat, *(IloNumVarArray*)(void*)&var);
    }
    ...
    void   getLBs(IloNumArray val, const IloIntVarArray vars) const {
      IloAssert(val.getImpl(), "array not initialized");
      IloAssert(vars.getImpl(), "array not initialized");
      doGetLbs(val, *(IloNumVarArray*)(void*)&vars);
    }
    ...
    void   getUBs(IloNumArray val, const IloIntVarArray vars) const {
      IloAssert(val.getImpl(), "array not initialized");
      IloAssert(vars.getImpl(), "array not initialized");
      doGetUbs(val, *(IloNumVarArray*)(void*)&vars);
    }
  ...
  public:
    ...
    NodeId makeBranch(const IloIntVarArray       vars,
      ...
      IloAssert(bounds.getImpl(), "array not initialized");
      IloAssert(dirs.getImpl(), "array not initialized");
      return (doMakeBranch(*(IloNumVarArray*)(void*)&vars,
                           bounds, dirs, objestimate, data));
    }
    ...
    NodeId makeBranch(const IloConstraintArray   cons,
      ...
      IloAssert(bounds.getImpl(), "array not initialized");
      IloAssert(dirs.getImpl(), "array not initialized");
      return (doMakeBranch(cons, *(IloNumVarArray*)(void*)&vars,
                           bounds, dirs, objestimate, data));
    }
  ...
  public:
    ...
    void setBounds(const IloIntVarArray var, const IloNumArray lb,
                                             const IloNumArray ub) {
       setBounds (*(IloNumVarArray*)(void*)&var, lb, ub);
    }
    ...
    void setSolution(const IloIntVarArray vars, const IloNumArray vals) {
      IloAssert(vars.getImpl(), "array not initialized");
      IloAssert(vals.getImpl(), "array not initialized");
      setSolution(*(IloNumVarArray*)(void*)&vars, vals, 0.0, IloFalse);
    }
    ...
    void setSolution(const IloIntVarArray vars, const IloNumArray vals,
      ...
      IloAssert(vars.getImpl(), "array not initialized");
      IloAssert(vals.getImpl(), "array not initialized");
      setSolution(*(IloNumVarArray*)(void*)&vars, vals, obj, IloTrue);
    }
  };
  ...
  public:
    ...
    void setVectors(const IloNumArray    x,
      ...
      IloAssert(rng.getImpl() == 0 || rng.getSize() == pi.getSize(),
                "Array lengths don't match");
      doSetVectors(x, *(IloNumVarArray*)(void*)&var, pi, rng);
    }
  };

  class CutCallbackI : public ControlCallbackI {
    Callback::Type getType() const;
  protected:
    friend class IloCplexCallbackManager;
    IloBool _lazy;
    CutCallbackI(IloEnv env) : ControlCallbackI(env), _lazy(IloTrue)  {}

  public:
    /* RW08-05-07: This method should remain undocumented.  For safety reasons
     * CutCallback is equivalent to LazyConstraintCallback, thus there should
     * not be the option to add purgeable cuts.
     */
    IloConstraint add(IloConstraint con, IloBool purgeable);

    IloConstraint add(IloConstraint con) {
       return (add(con,IloFalse));
    }

    IloConstraint addLocal(IloConstraint con);
  };

  class UserCutCallbackI : public CutCallbackI {
  protected:
    UserCutCallbackI(IloEnv env) : CutCallbackI(env) { _lazy = IloFalse; }

    IloConstraint add(IloConstraint con, IloBool purgeable=IloFalse) {
       return (CutCallbackI::add(con,purgeable));
    }
  };

  class LazyConstraintCallbackI : public CutCallbackI {
  protected:
    LazyConstraintCallbackI(IloEnv env) : CutCallbackI(env) {}
  };
  ...
  public:
    ...
    void getIncumbentValues (IloNumArray val,
                             const IloIntVarArray vars) const {
       getIncumbentValues (val, *(IloNumVarArray*)(void*)&vars);
    }
    ...
    void getFeasibilities(IntegerFeasibilityArray stats,
                          const IloIntVarArray vars) const {
       getFeasibilities(stats, *(IloNumVarArray*)(void*)&vars);
    }
    ...
    void getLBs(IloNumArray vals, const IloIntVarArray vars) const {
       getLBs(vals, *(IloNumVarArray*)(void*)&vars);
    }
    ...
    void getObjCoefs(IloNumArray vals,
                     const IloIntVarArray vars) const {
       getObjCoefs(vals, *(IloNumVarArray*)(void*)&vars);
    }
    ...
    void getUBs(IloNumArray vals, const IloIntVarArray vars) const {
       getUBs(vals, *(IloNumVarArray*)(void*)&vars);
    }
    ...
    IloNum getValue(const IloExpr expr) const;
    ...
    void getValues(IloNumArray vals, const IloIntVarArray vars) const {
       getValues(vals, *(IloNumVarArray*)(void*)&vars);
    }
...
public:
    enum Type {        Int, Num, Bool, String, Unknown };
    Type _t;
    int _key;
    union {
        IloInt Int;
...
inline IloInt IloCplex::Parameter::getIntValue() const {
    return _value.Int;
}
...
const char* CPXPUBLIC rowName (void* data, int ij, char* nameBuf);
const char* CPXPUBLIC colName (void* data, int ij, char* nameBuf);
const char* CPXPUBLIC quadName(void* data, int ij, char* nameBuf);
const char* CPXPUBLIC sosName (void* data, int ij, char* nameBuf);
}
...
private:
  ...
  char _tmpname[256];
  friend const char* CPXPUBLIC rowName (void* data, int ij, char *nameBuf);
  friend const char* CPXPUBLIC colName (void* data, int ij, char *nameBuf);
  friend const char* CPXPUBLIC quadName(void* data, int ij, char *nameBuf);
  friend const char* CPXPUBLIC sosName (void* data, int ij, char *nameBuf);
...
private:
  ...
  IloCarray<int>    _tmpi;
  IloCarray<char>   _tmpc;
  IloCarray<double> _tmpd;
...
public:
  ...
  int getNbarrierIterations() const;
  int getNsiftingIterations() const;
  int getNsiftingPhaseOneIterations() const;
...
inline IloInt   IloCplex::getNiterations() const {
  IloAssert (getImpl(), "accessing IloCplex through 0 handle");
  return (getImpl()->getNiterations());
}

inline IloInt   IloCplex::getNbarrierIterations() const {
  IloAssert (getImpl(), "accessing IloCplex through 0 handle");
  return (getImpl()->getNbarrierIterations());
}

inline IloInt   IloCplex::getNsiftingIterations() const {
  IloAssert (getImpl(), "accessing IloCplex through 0 handle");
  return (getImpl()->getNsiftingIterations());
}

inline IloInt   IloCplex::getNsiftingPhaseOneIterations() const {
  IloAssert (getImpl(), "accessing IloCplex through 0 handle");
...
inline IloInt   IloCplex::getNNZs() const {
  IloAssert (getImpl(), "accessing IloCplex through 0 handle");
...
inline void IloCplex::setParam(IntParam parameter, IloInt value) {
  IloAssert (getImpl(), "accessing IloCplex through 0 handle");
...
inline IloInt IloCplex::getParam(IntParam parameter) const {
  IloAssert (getImpl(), "accessing IloCplex through 0 handle");
...
inline IloInt      IloCplex::getDefault(IntParam    parameter) const {
  IloAssert (getImpl(), "accessing IloCplex through 0 handle");
  return (getImpl()->getDefault(parameter));
}
...
inline IloInt      IloCplex::getMin(IntParam    parameter) const {
  IloAssert (getImpl(), "accessing IloCplex through 0 handle");
...
inline IloInt      IloCplex::getMax(IntParam    parameter) const {
  IloAssert (getImpl(), "accessing IloCplex through 0 handle");
...
public:
  ...
  virtual void addToBeExtracted(const IloExtractable extractable) {}
  virtual void inhibit(IloBool b) {}
  ...
  virtual void setVerbosityLevel(IloInt l) {}
  virtual void apply(const IloChange& chg, const IloExtractableI* object) {}

  virtual void removeFromAll(IloInt id) {}
  virtual void removeToBeExtracted(const IloExtractable extractable)    {}
  virtual void fastEnd(IloExtractableI* object) { end(object, IloFalse); }
  virtual void addLink(IloExtractableI* super, IloExtractableI* sub)    {}
  virtual void removeLink(IloExtractableI* super, IloExtractableI* sub) {}
  virtual void addLink(IloExtractableI* super, IloExtractableArray sub) {}
  virtual void removeLink(IloExtractableI* super, IloExtractableArray sub) {}
  virtual IloBool hasLink(IloExtractableI* user, IloExtractableI* object) {
    return IloFalse;
  }
  virtual IloBool sendFullChange() const        { return IloFalse; }
  virtual void setSendFullChange(IloBool c)     {}
