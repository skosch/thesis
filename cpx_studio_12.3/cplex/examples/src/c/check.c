                     ...
                     const double *vallist)
{
   ...
   rowchgcnt = calloc(rows, sizeof(*rowchgcnt));
   rowchgbeg = calloc(rows, sizeof(*rowchgbeg));
   colchgind = calloc(numcoefs, sizeof(*colchgind));
   colchgprm = calloc(numcoefs, sizeof(*colchgprm));
   colchgcnt = calloc(cols, sizeof(*colchgcnt));
                  ...
                  const double *qmatval)
{
   ...
   iwork = calloc(numcols, sizeof(*iwork));
   if ( iwork == NULL ) {
                    ...
                    const char   *constrname)
{
  ...
  if ( linnzcnt < 0 || linnzcnt > numcols ) {
   ...
   qcolcnt = calloc(numcols, sizeof(*qcolcnt));
   qiwork  = calloc(numcols, sizeof(*qiwork));
   qrowcnt = calloc(numcols, sizeof(*qrowcnt));
   qrowbeg = calloc(numcols, sizeof(*qrowbeg));
   qrowind = calloc(quadnzcnt, sizeof(*qrowind));
           ...
           CPXCHANNELptr reschan)
{
   ...
   iwork = calloc(numrows, sizeof(*iwork));
   if ( iwork == NULL ) {
