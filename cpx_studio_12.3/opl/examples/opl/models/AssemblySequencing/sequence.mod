...
2) There is a upper bound on the number of computers in a row 
...
3) Each component also has a list of illegal followers 
   ...
   which appears in the illegal followers list of this component.  
...
subject to
{
   ...
   forall (c in UsedComponentTypes) {
      ...
      // The componenets in the 1st computer must appear at least minSeq # of times in a row.   
