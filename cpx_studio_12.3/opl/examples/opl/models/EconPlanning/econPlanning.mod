...
dvar float+ Output[i in Ind][y in 1..NbYears+2];
dvar float+ Stock[i in Ind][y in 1..NbYears+2];
dvar float+ Addcap[Ind][1..NbYears+2];
dvar float+ Cap[Ind][Years];
dvar float+ ManpowerUsed[0..NbYears];
