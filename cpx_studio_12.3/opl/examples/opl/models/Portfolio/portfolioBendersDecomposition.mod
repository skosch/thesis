...
/*************************MODEL SUMMARY*****************************
  ...
  a user defined stopping criteria for the Bender's iteration
...
main {
	...
	var EpsilonTolerance = thisOplModel.EpsilonTolerance; // Stopping Criteria for the Bender's iteration
	...
	writeln("Solve the portfolio problem using Bender's decomposition");
	
	
	// Put in dummy Bender's cut to get things started
	var NumberOfCuts = 1; // Number of Bender's Cuts 
