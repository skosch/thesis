 ...
 *  Click "OPL Samples and Models" on the Documentation home page.
 *   --------------------------------------------------- */
 ...
 *   suppliedCompmponents -- How many of each component
 *         type are supplied by which supplier
 *   inHouse -- How many of each component type are
 *         manufactured in House.
 *   grossProfit -- linear funciton of build
 *   cost -- funcion of suppliedComponents and inHouse
 *   --------------------------------------------------- */
 ...
 *   necessary components.  The objectivie is to 
