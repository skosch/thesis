...
public:
  ...
  IlcInt getMinDelta () const ILCDEPRECATED {
    IlcAssert(_impl != 0, "IlcIntVar: empty handle");
    return _getMinDelta();
  }
  IlcInt getMaxDelta () const ILCDEPRECATED {
    IlcAssert(_impl != 0, "IlcIntVar: empty handle");
    return _getMaxDelta();
  }
  ...
  // Deprecated
  void whenValue(const IlcGoal goal) const ILCDEPRECATED;
  void whenRange(const IlcGoal goal) const ILCDEPRECATED;
  void whenDomain(const IlcGoal goal) const ILCDEPRECATED;
  void removeWhen(const IlcDemon ct) const ILCDEPRECATED;
...
public:
  ...
  IlcFloat getMinDelta () const ILCDEPRECATED {
    IlcAssert(_impl != 0, "IlcFloatVar: empty handle");
    return _getVarMin() - _getOldMin();
  }
  IlcFloat getMaxDelta () const ILCDEPRECATED {
    IlcAssert(_impl != 0, "IlcFloatVar: empty handle");
