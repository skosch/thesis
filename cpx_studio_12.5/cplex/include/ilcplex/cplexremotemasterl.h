...
CPXLIBAPI
int CPXPUBLIC
   CPXLcopybase_async (CPXCENVptr env, CPXLPptr lp, const int *cstat,
...
CPXLIBAPI
int CPXPUBLIC
   CPXLcopystart_async (CPXCENVptr env, CPXLPptr lp, const int *cstat,
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetmethod_async (CPXCENVptr env, CPXCLPptr lp,
                        CPXASYNCptr *handle_p);


CPXLIBAPI
int CPXPUBLIC
   CPXLgetmethod_join (CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLfeasopt_async (CPXCENVptr env, CPXLPptr lp, const double *rhs,
...
int CPXPUBLIC
   CPXLaddrows_async (CPXCENVptr env, CPXLPptr lp, CPXINT ccnt,
                      CPXINT rcnt, CPXLONG nzcnt, const double *rhs,
...
int CPXPUBLIC
   CPXLchgcoeflist_async (CPXCENVptr env, CPXLPptr lp,
                          CPXLONG numcoefs, const CPXINT *rowlist,
                          const CPXINT *collist, const double *vallist,
                          CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetcolname_async (CPXCENVptr env, CPXCLPptr lp, char *namestore,
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetrowname_async (CPXCENVptr env, CPXCLPptr lp, char *namestore,
                         CPXSIZE storespace, CPXINT begin, CPXINT end,
                         CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetparamnum_async (CPXCENVptr env, const char *name_str,
                          CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLreadcopyparam_async (CPXENVptr env, const char *filename_str,
                            CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLwriteparam_async (CPXCENVptr env, const char *filename_str,
                         CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLcopydnorms_multicast (CPXENVGROUPptr group, const double *norm,
                             const CPXINT *head, CPXINT len);


CPXLIBAPI
int CPXPUBLIC
   CPXLpivotin_async (CPXCENVptr env, CPXLPptr lp, const CPXINT *rlist,
...
CPXLIBAPI
int CPXPUBLIC
   CPXLpivotin_multicast (CPXENVGROUPptr group, const CPXINT *rlist,
                          CPXINT rlen);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLpivotout_multicast (CPXENVGROUPptr group, const CPXINT *clist,
                           CPXINT clen);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLslackfromx_async (CPXCENVptr env, CPXCLPptr lp, const double *x,
                         CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLdjfrompi_async (CPXCENVptr env, CPXCLPptr lp, const double *pi,
                       CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLcrushx_async (CPXCENVptr env, CPXCLPptr lp, const double *x,
                     CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLcrushpi_async (CPXCENVptr env, CPXCLPptr lp, const double *pi,
                      CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetnummipstarts_async (CPXCENVptr env, CPXCLPptr lp,
                              CPXASYNCptr *handle_p);


CPXLIBAPI
int CPXPUBLIC
   CPXLgetnummipstarts_join (CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetsosname_async (CPXCENVptr env, CPXCLPptr lp, char *namestore,
                         CPXSIZE storespace, CPXINT begin, CPXINT end,
                         CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetsolnpoolnumfilters_async (CPXCENVptr env, CPXCLPptr lp,
                                    CPXASYNCptr *handle_p);


CPXLIBAPI
int CPXPUBLIC
   CPXLgetsolnpoolnumfilters_join (CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetsolnpoolfilter_async (CPXCENVptr env, CPXCLPptr lp,
                                CPXINT space, int which,
                                CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetsolnpoolfilter_join (CPXASYNCptr *handle_p, int *ftype_p,
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetsolnpoolnumsolns_async (CPXCENVptr env, CPXCLPptr lp,
                                  CPXASYNCptr *handle_p);


CPXLIBAPI
int CPXPUBLIC
   CPXLgetsolnpoolnumsolns_join (CPXASYNCptr *handle_p);


CPXLIBAPI
int CPXPUBLIC
   CPXLgetsolnpoolnumreplaced_async (CPXCENVptr env, CPXCLPptr lp,
                                     CPXASYNCptr *handle_p);


CPXLIBAPI
int CPXPUBLIC
   CPXLgetsolnpoolnumreplaced_join (CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLordread_async (CPXCENVptr env, const char *filename_str,
...
int CPXPUBLIC
   CPXLcopyquad_async (CPXCENVptr env, CPXLPptr lp,
                       const CPXLONG *qmatbeg, const CPXINT *qmatcnt,
