...
int CPXPUBLIC
   CPXScopylpwnames_async (CPXCENVptr env, CPXLPptr lp, CPXINT numcols,
                           ...
                           const char *sense, const CPXINT *matbeg,
...
CPXLIBAPI
int CPXPUBLIC
   CPXScopybase_async (CPXCENVptr env, CPXLPptr lp, const int *cstat,
...
CPXLIBAPI
int CPXPUBLIC
   CPXScopystart_async (CPXCENVptr env, CPXLPptr lp, const int *cstat,
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetmethod_async (CPXCENVptr env, CPXCLPptr lp,
                        CPXASYNCptr *handle_p);


CPXLIBAPI
int CPXPUBLIC
   CPXSgetmethod_join (CPXASYNCptr *handle_p);
...
int CPXPUBLIC
   CPXSgetrowinfeas_async (CPXCENVptr env, CPXCLPptr lp,
                           const double *x, CPXINT begin, CPXINT end,
                           CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSfeasopt_async (CPXCENVptr env, CPXLPptr lp, const double *rhs,
...
int CPXPUBLIC
   CPXSfeasoptext_async (CPXCENVptr env, CPXLPptr lp, CPXINT grpcnt,
                         CPXINT concnt, const double *grppref,
                         const CPXINT *grpbeg, const CPXINT *grpind,
...
int CPXPUBLIC
   CPXSfeasoptext_multicast (CPXENVGROUPptr group, CPXINT grpcnt,
                             CPXINT concnt, const double *grppref,
                             const CPXINT *grpbeg,
                             const CPXINT *grpind, const char *grptype);
...
int CPXPUBLIC
   CPXSaddrows_async (CPXCENVptr env, CPXLPptr lp, CPXINT ccnt,
                      CPXINT rcnt, CPXINT nzcnt, const double *rhs,
                      const char *sense, const CPXINT *rmatbeg,
...
int CPXPUBLIC
   CPXSaddcols_async (CPXCENVptr env, CPXLPptr lp, CPXINT ccnt,
                      CPXINT nzcnt, const double *obj,
                      const CPXINT *cmatbeg, const CPXINT *cmatind,
...
int CPXPUBLIC
   CPXSchgcoeflist_multicast (CPXENVGROUPptr group, CPXINT numcoefs,
                              const CPXINT *rowlist,
                              const CPXINT *collist,
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetcolname_async (CPXCENVptr env, CPXCLPptr lp, char *namestore,
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetrowname_async (CPXCENVptr env, CPXCLPptr lp, char *namestore,
                         CPXSIZE storespace, CPXINT begin, CPXINT end,
                         CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetparamnum_async (CPXCENVptr env, const char *name_str,
                          CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSreadcopyparam_async (CPXENVptr env, const char *filename_str,
                            CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSwriteparam_async (CPXCENVptr env, const char *filename_str,
                         CPXASYNCptr *handle_p);
...
int CPXPUBLIC
   CPXScopypartialbase_multicast (CPXENVGROUPptr group, CPXINT ccnt,
                                  const CPXINT *cindices,
                                  const int *cstat, CPXINT rcnt,
                                  const CPXINT *rindices,
                                  const int *rstat);
...
int CPXPUBLIC
   CPXScopydnorms_async (CPXCENVptr env, CPXLPptr lp,
                         const double *norm, const CPXINT *head,
...
CPXLIBAPI
int CPXPUBLIC
   CPXScopydnorms_multicast (CPXENVGROUPptr group, const double *norm,
                             const CPXINT *head, CPXINT len);


CPXLIBAPI
int CPXPUBLIC
   CPXSpivotin_async (CPXCENVptr env, CPXLPptr lp, const CPXINT *rlist,
...
CPXLIBAPI
int CPXPUBLIC
   CPXSpivotin_multicast (CPXENVGROUPptr group, const CPXINT *rlist,
                          CPXINT rlen);
...
int CPXPUBLIC
   CPXSpivotout_async (CPXCENVptr env, CPXLPptr lp,
                       const CPXINT *clist, CPXINT clen,
                       CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSpivotout_multicast (CPXENVGROUPptr group, const CPXINT *clist,
                           CPXINT clen);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSslackfromx_async (CPXCENVptr env, CPXCLPptr lp, const double *x,
                         CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSdjfrompi_async (CPXCENVptr env, CPXCLPptr lp, const double *pi,
                       CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXScrushx_async (CPXCENVptr env, CPXCLPptr lp, const double *x,
                     CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXScrushpi_async (CPXCENVptr env, CPXCLPptr lp, const double *pi,
                      CPXASYNCptr *handle_p);
...
int CPXPUBLIC
   CPXScopysos_async (CPXCENVptr env, CPXLPptr lp, CPXINT numsos,
                      CPXINT numsosnz, const char *sostype,
                      const CPXINT *sosbeg, const CPXINT *sosind,
...
int CPXPUBLIC
   CPXSchgmipstarts_async (CPXCENVptr env, CPXLPptr lp, int mcnt,
                           const int *mipstartindices, CPXINT nzcnt,
                           const CPXINT *beg, const CPXINT *varindices,
                           const double *values,
...
int CPXPUBLIC
   CPXSchgmipstarts_multicast (CPXENVGROUPptr group, int mcnt,
                               ...
                               CPXINT nzcnt, const CPXINT *beg,
                               const CPXINT *varindices,
                               const double *values,
                               const int *effortlevel);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetnummipstarts_async (CPXCENVptr env, CPXCLPptr lp,
                              CPXASYNCptr *handle_p);


CPXLIBAPI
int CPXPUBLIC
   CPXSgetnummipstarts_join (CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetsosname_async (CPXCENVptr env, CPXCLPptr lp, char *namestore,
                         CPXSIZE storespace, CPXINT begin, CPXINT end,
                         CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetsolnpoolnumfilters_async (CPXCENVptr env, CPXCLPptr lp,
                                    CPXASYNCptr *handle_p);


CPXLIBAPI
int CPXPUBLIC
   CPXSgetsolnpoolnumfilters_join (CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetsolnpoolfilter_async (CPXCENVptr env, CPXCLPptr lp,
                                CPXINT space, int which,
                                CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetsolnpoolfilter_join (CPXASYNCptr *handle_p, int *ftype_p,
                               double *lowercutoff_p,
                               double *upper_cutoff_p, CPXINT *nzcnt_p,
                               CPXINT *ind, double *val,
                               double *refval, CPXINT *surplus_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetsolnpoolnumsolns_async (CPXCENVptr env, CPXCLPptr lp,
                                  CPXASYNCptr *handle_p);


CPXLIBAPI
int CPXPUBLIC
   CPXSgetsolnpoolnumsolns_join (CPXASYNCptr *handle_p);


CPXLIBAPI
int CPXPUBLIC
   CPXSgetsolnpoolnumreplaced_async (CPXCENVptr env, CPXCLPptr lp,
                                     CPXASYNCptr *handle_p);


CPXLIBAPI
int CPXPUBLIC
   CPXSgetsolnpoolnumreplaced_join (CPXASYNCptr *handle_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSordread_async (CPXCENVptr env, const char *filename_str,
...
int CPXPUBLIC
   CPXScopyquad_async (CPXCENVptr env, CPXLPptr lp,
                       const CPXINT *qmatbeg, const CPXINT *qmatcnt,
                       const CPXINT *qmatind, const double *qmatval,
                       CPXASYNCptr *handle_p);
