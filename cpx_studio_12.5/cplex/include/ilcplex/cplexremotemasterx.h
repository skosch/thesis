...
int CPXPUBLIC
   CPXXcopylpwnames_async (CPXCENVptr env, CPXLPptr lp, CPXDIM numcols,
                           ...
                           const char *sense, const CPXNNZ *matbeg,
                           const CPXDIM *matcnt, const CPXDIM *matind,
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXcopybase_async (CPXCENVptr env, CPXLPptr lp, const int *cstat,
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXcopystart_async (CPXCENVptr env, CPXLPptr lp, const int *cstat,
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXgetmethod_async (CPXCENVptr env, CPXCLPptr lp,
                        CPXASYNCptr *handle_p)
{
   return CPX_CALL (getmethod_async) (env, lp, handle_p);
}
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXgetmethod_join (CPXASYNCptr *handle_p)
{
   return CPX_CALL (getmethod_join) (handle_p);
}
...
int CPXPUBLIC
   CPXXgetrowinfeas_async (CPXCENVptr env, CPXCLPptr lp,
                           const double *x, CPXDIM begin, CPXDIM end,
                           CPXASYNCptr *handle_p)
{
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXfeasopt_async (CPXCENVptr env, CPXLPptr lp, const double *rhs,
...
int CPXPUBLIC
   CPXXfeasoptext_async (CPXCENVptr env, CPXLPptr lp, CPXDIM grpcnt,
                         CPXNNZ concnt, const double *grppref,
                         const CPXNNZ *grpbeg, const CPXDIM *grpind,
...
int CPXPUBLIC
   CPXXfeasoptext_multicast (CPXENVGROUPptr group, CPXDIM grpcnt,
                             CPXNNZ concnt, const double *grppref,
                             const CPXNNZ *grpbeg,
                             const CPXDIM *grpind, const char *grptype)
{
...
int CPXPUBLIC
   CPXXchgobj_async (CPXCENVptr env, CPXLPptr lp, CPXDIM cnt,
                     const CPXDIM *indices, const double *values,
                     CPXASYNCptr *handle_p)
{
...
int CPXPUBLIC
   CPXXchgsense_async (CPXCENVptr env, CPXLPptr lp, CPXDIM cnt,
                       const CPXDIM *indices, const char *sense,
                       CPXASYNCptr *handle_p)
{
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXgetcolname_async (CPXCENVptr env, CPXCLPptr lp, char *namestore,
                         CPXSIZE storespace, CPXDIM begin, CPXDIM end,
                         CPXASYNCptr *handle_p)
{
   return CPX_CALL (getcolname_async) (env, lp, namestore, storespace, begin, end, handle_p);
}
...
int CPXPUBLIC
   CPXXgetcolname_join (CPXASYNCptr *handle_p, char  **name,
                        CPXSIZE *surplus_p)
{
   return CPX_CALL (getcolname_join) (handle_p, name, surplus_p);
}
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXgetrowname_async (CPXCENVptr env, CPXCLPptr lp, char *namestore,
                         CPXSIZE storespace, CPXDIM begin, CPXDIM end,
                         CPXASYNCptr *handle_p)
{
   return CPX_CALL (getrowname_async) (env, lp, namestore, storespace, begin, end, handle_p);
}
...
int CPXPUBLIC
   CPXXgetrowname_join (CPXASYNCptr *handle_p, char  **name,
                        CPXSIZE *surplus_p)
{
   return CPX_CALL (getrowname_join) (handle_p, name, surplus_p);
}
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXgetparamnum_async (CPXCENVptr env, const char *name_str,
                          CPXASYNCptr *handle_p)
{
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXreadcopyparam_async (CPXENVptr env, const char *filename_str,
                            CPXASYNCptr *handle_p)
{
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXwriteparam_async (CPXCENVptr env, const char *filename_str,
                         CPXASYNCptr *handle_p)
{
...
int CPXPUBLIC
   CPXXmdleave_async (CPXCENVptr env, CPXLPptr lp,
                      const CPXDIM *indices, CPXDIM cnt,
                      CPXASYNCptr *handle_p)
{
...
int CPXPUBLIC
   CPXXcopypartialbase_async (CPXCENVptr env, CPXLPptr lp, CPXDIM ccnt,
                              const CPXDIM *cindices, const int *cstat,
                              CPXDIM rcnt, const CPXDIM *rindices,
                              const int *rstat, CPXASYNCptr *handle_p)
{
...
int CPXPUBLIC
   CPXXcopypartialbase_multicast (CPXENVGROUPptr group, CPXDIM ccnt,
                                  const CPXDIM *cindices,
                                  const int *cstat, CPXDIM rcnt,
                                  const CPXDIM *rindices,
                                  const int *rstat)
{
...
int CPXPUBLIC
   CPXXcopydnorms_async (CPXCENVptr env, CPXLPptr lp,
                         const double *norm, const CPXDIM *head,
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXcopydnorms_multicast (CPXENVGROUPptr group, const double *norm,
                             const CPXDIM *head, CPXDIM len)
{
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXpivotin_async (CPXCENVptr env, CPXLPptr lp, const CPXDIM *rlist,
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXpivotin_multicast (CPXENVGROUPptr group, const CPXDIM *rlist,
                          CPXDIM rlen)
{
...
int CPXPUBLIC
   CPXXpivotout_async (CPXCENVptr env, CPXLPptr lp,
                       const CPXDIM *clist, CPXDIM clen,
                       CPXASYNCptr *handle_p)
{
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXpivotout_multicast (CPXENVGROUPptr group, const CPXDIM *clist,
                           CPXDIM clen)
{
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXslackfromx_async (CPXCENVptr env, CPXCLPptr lp, const double *x,
                         CPXASYNCptr *handle_p)
{
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXdjfrompi_async (CPXCENVptr env, CPXCLPptr lp, const double *pi,
                       CPXASYNCptr *handle_p)
{
...
int CPXPUBLIC
   CPXXqpdjfrompi_async (CPXCENVptr env, CPXCLPptr lp,
                         const double *pi, const double *x,
                         CPXASYNCptr *handle_p)
{
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXcrushx_async (CPXCENVptr env, CPXCLPptr lp, const double *x,
                     CPXASYNCptr *handle_p)
{
...
int CPXPUBLIC
   CPXXuncrushx_async (CPXCENVptr env, CPXCLPptr lp,
                       const double *prex, CPXASYNCptr *handle_p)
{
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXcrushpi_async (CPXCENVptr env, CPXCLPptr lp, const double *pi,
                      CPXASYNCptr *handle_p)
{
...
int CPXPUBLIC
   CPXXcopyctype_async (CPXCENVptr env, CPXLPptr lp,
                        const char *xctype, CPXASYNCptr *handle_p)
{
...
int CPXPUBLIC
   CPXXcopyorder_async (CPXCENVptr env, CPXLPptr lp, CPXDIM cnt,
                        const CPXDIM *indices, const CPXDIM *priority,
...
int CPXPUBLIC
   CPXXchgmipstarts_async (CPXCENVptr env, CPXLPptr lp, int mcnt,
                           const int *mipstartindices, CPXNNZ nzcnt,
                           const CPXNNZ *beg, const CPXDIM *varindices,
                           const double *values,
...
int CPXPUBLIC
   CPXXchgmipstarts_multicast (CPXENVGROUPptr group, int mcnt,
                               const int *mipstartindices,
                               CPXNNZ nzcnt, const CPXNNZ *beg,
                               const CPXDIM *varindices,
                               const double *values,
                               const int *effortlevel)
{
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXgetnummipstarts_async (CPXCENVptr env, CPXCLPptr lp,
                              CPXASYNCptr *handle_p)
{
   return CPX_CALL (getnummipstarts_async) (env, lp, handle_p);
}
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXgetnummipstarts_join (CPXASYNCptr *handle_p)
{
   return CPX_CALL (getnummipstarts_join) (handle_p);
}
...
int CPXPUBLIC
   CPXXgetmipstartname_async (CPXCENVptr env, CPXCLPptr lp,
                              char *store, CPXSIZE storesz, int begin,
                              int end, CPXASYNCptr *handle_p)
{
   return CPX_CALL (getmipstartname_async) (env, lp, store, storesz, begin, end, handle_p);
}
...
int CPXPUBLIC
   CPXXgetmipstartname_join (CPXASYNCptr *handle_p, char  **name,
                             CPXSIZE *surplus_p)
{
   return CPX_CALL (getmipstartname_join) (handle_p, name, surplus_p);
}
...
int CPXPUBLIC
   CPXXchgctype_async (CPXCENVptr env, CPXLPptr lp, CPXDIM cnt,
                       const CPXDIM *indices, const char *xctype,
                       CPXASYNCptr *handle_p)
{
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXgetsosname_async (CPXCENVptr env, CPXCLPptr lp, char *namestore,
                         CPXSIZE storespace, CPXDIM begin, CPXDIM end,
                         CPXASYNCptr *handle_p)
{
   return CPX_CALL (getsosname_async) (env, lp, namestore, storespace, begin, end, handle_p);
}
...
int CPXPUBLIC
   CPXXgetsosname_join (CPXASYNCptr *handle_p, char  **name,
                        CPXSIZE *surplus_p)
{
   return CPX_CALL (getsosname_join) (handle_p, name, surplus_p);
}
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXgetsolnpoolnumfilters_async (CPXCENVptr env, CPXCLPptr lp,
                                    CPXASYNCptr *handle_p)
{
   return CPX_CALL (getsolnpoolnumfilters_async) (env, lp, handle_p);
}
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXgetsolnpoolnumfilters_join (CPXASYNCptr *handle_p)
{
   return CPX_CALL (getsolnpoolnumfilters_join) (handle_p);
}
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXgetsolnpoolfilter_async (CPXCENVptr env, CPXCLPptr lp,
                                CPXDIM space, int which,
                                CPXASYNCptr *handle_p)
{
   return CPX_CALL (getsolnpoolfilter_async) (env, lp, space, which, handle_p);
}
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXgetsolnpoolfilter_join (CPXASYNCptr *handle_p, int *ftype_p,
                               double *lowercutoff_p,
                               double *upper_cutoff_p, CPXDIM *nzcnt_p,
                               CPXDIM *ind, double *val,
                               double *refval, CPXDIM *surplus_p)
{
   return CPX_CALL (getsolnpoolfilter_join) (handle_p, ftype_p, lowercutoff_p, upper_cutoff_p, nzcnt_p, ind, val, refval, surplus_p);
}
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXgetsolnpoolnumsolns_async (CPXCENVptr env, CPXCLPptr lp,
                                  CPXASYNCptr *handle_p)
{
   return CPX_CALL (getsolnpoolnumsolns_async) (env, lp, handle_p);
}
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXgetsolnpoolnumsolns_join (CPXASYNCptr *handle_p)
{
   return CPX_CALL (getsolnpoolnumsolns_join) (handle_p);
}
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXgetsolnpoolnumreplaced_async (CPXCENVptr env, CPXCLPptr lp,
                                     CPXASYNCptr *handle_p)
{
   return CPX_CALL (getsolnpoolnumreplaced_async) (env, lp, handle_p);
}
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXgetsolnpoolnumreplaced_join (CPXASYNCptr *handle_p)
{
   return CPX_CALL (getsolnpoolnumreplaced_join) (handle_p);
}
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXordread_async (CPXCENVptr env, const char *filename_str,
...
int CPXPUBLIC
   CPXXNETcopynet_async (CPXCENVptr env, CPXNETptr net, int objsen,
                         CPXDIM nnodes, const double *supply,
                         char const *const *nnames, CPXDIM narcs,
                         const CPXDIM *fromnode, const CPXDIM *tonode,
...
int CPXPUBLIC
   CPXXNETchgname_async (CPXCENVptr env, CPXNETptr net, int key,
                         CPXDIM vindex, const char *name_str,
                         CPXASYNCptr *handle_p)
{
...
int CPXPUBLIC
   CPXXNETchgobj_async (CPXCENVptr env, CPXNETptr net, CPXDIM cnt,
                        const CPXDIM *indices, const double *obj,
                        CPXASYNCptr *handle_p)
{
...
int CPXPUBLIC
   CPXXNETchgsupply_async (CPXCENVptr env, CPXNETptr net, CPXDIM cnt,
                           const CPXDIM *indices, const double *supply,
                           CPXASYNCptr *handle_p)
{
...
int CPXPUBLIC
   CPXXNETgetnodename_async (CPXCENVptr env, CPXCNETptr net,
                             ...
                             CPXASYNCptr *handle_p)
{
   return CPX_CALL (NETgetnodename_async) (env, net, namestore, namespc, begin, end, handle_p);
}
...
int CPXPUBLIC
   CPXXNETgetnodename_join (CPXASYNCptr *handle_p, char  **nnames,
                            CPXSIZE *surplus_p)
{
   return CPX_CALL (NETgetnodename_join) (handle_p, nnames, surplus_p);
}
...
int CPXPUBLIC
   CPXXNETgetarcname_async (CPXCENVptr env, CPXCNETptr net,
                            ...
                            CPXASYNCptr *handle_p)
{
   return CPX_CALL (NETgetarcname_async) (env, net, namestore, namespc, begin, end, handle_p);
}
...
int CPXPUBLIC
   CPXXNETgetarcname_join (CPXASYNCptr *handle_p, char  **nnames,
                           CPXSIZE *surplus_p)
{
   return CPX_CALL (NETgetarcname_join) (handle_p, nnames, surplus_p);
}
...
int CPXPUBLIC
   CPXXcopyquad_async (CPXCENVptr env, CPXLPptr lp,
                       const CPXNNZ *qmatbeg, const CPXDIM *qmatcnt,
                       const CPXDIM *qmatind, const double *qmatval,
                       CPXASYNCptr *handle_p)
{
...
int CPXPUBLIC
   CPXXaddqconstr_async (CPXCENVptr env, CPXLPptr lp, CPXDIM linnzcnt,
                         ...
                         const CPXDIM *linind, const double *linval,
                         const CPXDIM *quadrow, const CPXDIM *quadcol,
