...
int CPXPUBLIC
   CPXScopylp (CPXCENVptr env, CPXLPptr lp, CPXINT numcols,
               ...
               const CPXINT *matbeg, const CPXINT *matcnt,
...
CPXLIBAPI
int CPXPUBLIC
   CPXScopybase (CPXCENVptr env, CPXLPptr lp, const int *cstat,
                 const int *rstat);
...
CPXLIBAPI
int CPXPUBLIC
   CPXScopystart (CPXCENVptr env, CPXLPptr lp, const int *cstat,
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetrowinfeas (CPXCENVptr env, CPXCLPptr lp, const double *x,
                     double *infeasout, CPXINT begin, CPXINT end);


CPXLIBAPI
int CPXPUBLIC
   CPXSgetcolinfeas (CPXCENVptr env, CPXCLPptr lp, const double *x,
                     double *infeasout, CPXINT begin, CPXINT end);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSfeasopt (CPXCENVptr env, CPXLPptr lp, const double *rhs,
...
int CPXPUBLIC
   CPXSaddrows (CPXCENVptr env, CPXLPptr lp, CPXINT ccnt, CPXINT rcnt,
                CPXINT nzcnt, const double *rhs, const char *sense,
                const CPXINT *rmatbeg, const CPXINT *rmatind,
...
int CPXPUBLIC
   CPXSaddcols (CPXCENVptr env, CPXLPptr lp, CPXINT ccnt, CPXINT nzcnt,
                const double *obj, const CPXINT *cmatbeg,
                const CPXINT *cmatind, const double *cmatval,
                const double *lb, const double *ub,
                char const *const *colname);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSchgprobname (CPXCENVptr env, CPXLPptr lp, const char *probname);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetparamnum (CPXCENVptr env, const char *name_str,
                    int *whichparam_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSmdleave (CPXCENVptr env, CPXLPptr lp, const CPXINT *indices,
                CPXINT cnt, double *downratio, double *upratio);
...
CPXLIBAPI
int CPXPUBLIC
   CPXScopybasednorms (CPXCENVptr env, CPXLPptr lp, const int *cstat,
...
CPXLIBAPI
int CPXPUBLIC
   CPXScopydnorms (CPXCENVptr env, CPXLPptr lp, const double *norm,
...
CPXLIBAPI
int CPXPUBLIC
   CPXScopypnorms (CPXCENVptr env, CPXLPptr lp, const double *cnorm,
...
CPXLIBAPI
int CPXPUBLIC
   CPXSpivotin (CPXCENVptr env, CPXLPptr lp, const CPXINT *rlist,
                CPXINT rlen);


CPXLIBAPI
int CPXPUBLIC
   CPXSpivotout (CPXCENVptr env, CPXLPptr lp, const CPXINT *clist,
                 CPXINT clen);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSslackfromx (CPXCENVptr env, CPXCLPptr lp, const double *x,
                   double *slack);


CPXLIBAPI
int CPXPUBLIC
   CPXSdjfrompi (CPXCENVptr env, CPXCLPptr lp, const double *pi,
                 double *dj);


CPXLIBAPI
int CPXPUBLIC
   CPXSqpdjfrompi (CPXCENVptr env, CPXCLPptr lp, const double *pi,
...
CPXLIBAPI
int CPXPUBLIC
   CPXScrushx (CPXCENVptr env, CPXCLPptr lp, const double *x,
               double *prex);
...
CPXLIBAPI
int CPXPUBLIC
   CPXScrushpi (CPXCENVptr env, CPXCLPptr lp, const double *pi,
                double *prepi);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSsavwritedev (CPXCENVptr env, CPXCLPptr lp,
...
CPXLIBAPI
int CPXPUBLIC
   CPXScopyquad (CPXCENVptr env, CPXLPptr lp, const CPXINT *qmatbeg,
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetqconstrinfeas (CPXCENVptr env, CPXCLPptr lp, const double *x,
                         double *infeasout, CPXINT begin, CPXINT end);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSNETcopybase (CPXCENVptr env, CPXNETptr net, const int *astat,
                    const int *nstat);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetsosinfeas (CPXCENVptr env, CPXCLPptr lp, const double *x,
                     double *infeasout, CPXINT begin, CPXINT end);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetsolnpoolfilter (CPXCENVptr env, CPXCLPptr lp, int *ftype_p,
...
CPXLIBAPI
int CPXPUBLIC
   CPXSordread (CPXCENVptr env, const char *filename_str,
