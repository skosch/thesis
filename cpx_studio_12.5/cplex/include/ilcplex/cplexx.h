...
int CPXPUBLIC
   CPXXcopylp (CPXCENVptr env, CPXLPptr lp, CPXDIM numcols,
               CPXDIM numrows, int objsense, const double *objective,
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXcopybase (CPXCENVptr env, CPXLPptr lp, const int *cstat,
                 const int *rstat)
{
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXcopystart (CPXCENVptr env, CPXLPptr lp, const int *cstat,
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXgetrowinfeas (CPXCENVptr env, CPXCLPptr lp, const double *x,
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXgetcolinfeas (CPXCENVptr env, CPXCLPptr lp, const double *x,
                     double *infeasout, CPXDIM begin, CPXDIM end)
{
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXfeasopt (CPXCENVptr env, CPXLPptr lp, const double *rhs,
...
int CPXPUBLIC
   CPXXaddrows (CPXCENVptr env, CPXLPptr lp, CPXDIM ccnt, CPXDIM rcnt,
                CPXNNZ nzcnt, const double *rhs, const char *sense,
                const CPXNNZ *rmatbeg, const CPXDIM *rmatind,
...
int CPXPUBLIC
   CPXXaddcols (CPXCENVptr env, CPXLPptr lp, CPXDIM ccnt, CPXNNZ nzcnt,
                const double *obj, const CPXNNZ *cmatbeg,
                const CPXDIM *cmatind, const double *cmatval,
                const double *lb, const double *ub,
                char const *const *colname)
{
...
int CPXPUBLIC
   CPXXchgrowname (CPXCENVptr env, CPXLPptr lp, CPXDIM cnt,
                   const CPXDIM *indices, char const *const *newname)
{
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXchgprobname (CPXCENVptr env, CPXLPptr lp, const char *probname)
{
...
int CPXPUBLIC
   CPXXgetrowindex (CPXCENVptr env, CPXCLPptr lp,
                    const char *lname_str, CPXDIM *index_p)
{
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXgetparamnum (CPXCENVptr env, const char *name_str,
                    int *whichparam_p)
{
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXmdleave (CPXCENVptr env, CPXLPptr lp, const CPXDIM *indices,
                CPXDIM cnt, double *downratio, double *upratio)
{
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXcopybasednorms (CPXCENVptr env, CPXLPptr lp, const int *cstat,
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXcopydnorms (CPXCENVptr env, CPXLPptr lp, const double *norm,
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXcopypnorms (CPXCENVptr env, CPXLPptr lp, const double *cnorm,
                   const double *rnorm, CPXDIM len)
{
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXpivotin (CPXCENVptr env, CPXLPptr lp, const CPXDIM *rlist,
                CPXDIM rlen)
{
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXpivotout (CPXCENVptr env, CPXLPptr lp, const CPXDIM *clist,
                 CPXDIM clen)
{
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXslackfromx (CPXCENVptr env, CPXCLPptr lp, const double *x,
                   double *slack)
{
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXdjfrompi (CPXCENVptr env, CPXCLPptr lp, const double *pi,
                 double *dj)
{
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXqpdjfrompi (CPXCENVptr env, CPXCLPptr lp, const double *pi,
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXcrushx (CPXCENVptr env, CPXCLPptr lp, const double *x,
               double *prex)
{
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXcrushpi (CPXCENVptr env, CPXCLPptr lp, const double *pi,
                double *prepi)
{
...
int CPXPUBLIC
   CPXXcrushform (CPXCENVptr env, CPXCLPptr lp, CPXDIM len,
                  const CPXDIM *ind, const double *val, CPXDIM *plen_p,
...
int CPXPUBLIC
   CPXXuncrushform (CPXCENVptr env, CPXCLPptr lp, CPXDIM plen,
                    const CPXDIM *pind, const double *pval,
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXsavwritedev (CPXCENVptr env, CPXCLPptr lp,
                    const char *filename_str, CPXIODEVICEptr dev)
{
   return CPX_CALL (savwritedev) (env, lp, filename_str, dev);
}
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXcopyquad (CPXCENVptr env, CPXLPptr lp, const CPXNNZ *qmatbeg,
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXgetqconstrinfeas (CPXCENVptr env, CPXCLPptr lp, const double *x,
                         double *infeasout, CPXDIM begin, CPXDIM end)
{
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXNETcopybase (CPXCENVptr env, CPXNETptr net, const int *astat,
                    const int *nstat)
{
...
int CPXPUBLIC
   CPXXNETchgarcnodes (CPXCENVptr env, CPXNETptr net, CPXDIM cnt,
                       const CPXDIM *indices, const CPXDIM *fromnode,
                       const CPXDIM *tonode)
{
...
int CPXPUBLIC
   CPXXaddmipstarts (CPXCENVptr env, CPXLPptr lp, int mcnt,
                     ...
                     const CPXDIM *varindices, const double *values,
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXgetsosinfeas (CPXCENVptr env, CPXCLPptr lp, const double *x,
                     double *infeasout, CPXDIM begin, CPXDIM end)
{
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXgetsolnpoolfilter (CPXCENVptr env, CPXCLPptr lp, int *ftype_p,
                          double *lowercutoff_p,
                          double *upper_cutoff_p, CPXDIM *nzcnt_p,
                          CPXDIM *ind, double *val, double *refval,
                          CPXDIM space, CPXDIM *surplus_p, int which)
{
...
int CPXPUBLIC
   CPXXcutcallbackadd (CPXCENVptr env, void *cbdata, int wherefrom,
                       ...
                       const CPXDIM *cutind, const double *cutval,
                       int purgeable)
{
...
int CPXPUBLIC
   CPXXbranchcallbackbranchbds (CPXCENVptr env, void *cbdata,
                                ...
                                CPXDIM cnt, const CPXDIM *indices,
...
int CPXPUBLIC
   CPXXbranchcallbackbranchgeneral (CPXCENVptr env, void *cbdata,
                                    ...
                                    void *userhandle, CPXCNT *seqnum_p)
{
   return CPX_CALL (branchcallbackbranchgeneral) (env, cbdata, wherefrom, nodeest, varcnt, varind, varlu, varbd, rcnt, nzcnt, rhs, sense, rmatbeg, rmatind, rmatval, userhandle, seqnum_p);
}
...
int CPXPUBLIC
   CPXXbranchcallbackbranchconstraints (CPXCENVptr env, void *cbdata,
                                        ...
                                        CPXCNT *seqnum_p)
{
   return CPX_CALL (branchcallbackbranchconstraints) (env, cbdata, wherefrom, nodeest, rcnt, nzcnt, rhs, sense, rmatbeg, rmatind, rmatval, userhandle, seqnum_p);
}
...
CPX_STATIC_INLINE
int CPXPUBLIC
   CPXXordread (CPXCENVptr env, const char *filename_str,
