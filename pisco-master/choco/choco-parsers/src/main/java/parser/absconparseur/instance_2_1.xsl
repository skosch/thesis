...
<!-- $Header: /server/CVS/abscon/absconCVS4/src/abscon/instance/instance_2_1.xsl,v 1.2 2008/01/24 17:56:08 lecoutre Exp $ -->
...
<instance>
<xsl:apply-templates />  <!-- select="presentation | domains | variables | relations | predicates | constraints | parameters"/> -->
</instance>
</xsl:template>
