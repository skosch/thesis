...
This heuristic works with the \mylst{ConstraintType.FASTCOSTREGULAR} implementation of the constraint (preferred): see \hyperlink{costregularvalselector:costregularvalselectorvalselector}{CostRegularValSelector} for use with the \mylst{ConstraintType.COSTREGULAR} implementation.
