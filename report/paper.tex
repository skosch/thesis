...
\frontmatter
\chapter*{Abstract}
Ovens, washers, driers and autoclaves are examples of \textit{batch processing
machines} and used in many industries. We examine the problem of
...
perform better than a simple mixed-integer formulation. In this paper, we
...
\begin{adjustwidth}{1in}{1in}
  ...
  Thank you for being a model supervisor.\\[3ex]
     And I could not have made it this far without two incredible parents and an
     amazing girlfriend.
...
\input{figures/results_graph.tex} The new, move-based MIP model trumps all other
...
papier, but may be of use in further research. 
